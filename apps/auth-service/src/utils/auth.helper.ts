...
/**
 * Check OTP without necessarily deleting it on success.
 * If `deleteOnSuccess` is true this behaves like `verifyOtp` (removes otp and attempts on success).
 * If false it only validates (and applies failed-attempts/lock logic) but keeps the otp key.
 */
